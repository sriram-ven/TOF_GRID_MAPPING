function R = AxisCalibration(accelData, magData);
[Ap, Bp] = CalibrateEllipsoidData3D(accelData(:,1), accelData(:,2), accelData(:,3), 20, 0);
[As, Bs] = CalibrateEllipsoidData3D(magData(:,1), magData(:,2), magData(:,3), 20, 0);
